...
<template>
    <section>
        ...
        >
         ...
         <q-step
        :name="3"
        title="Preencha o formulário de venda"
        icon="point_of_sale"
        >
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Itaque commodi nihil rerum nobis enim laboriosam assumenda odit aspernatur veniam praesentium? Nobis aut dolore consequatur ipsum eius ab quae fugit consectetur.
            <q-stepper-navigation align="right">
                <q-btn
                label="Tetse"
                color="primary"
