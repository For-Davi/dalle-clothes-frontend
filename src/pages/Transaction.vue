    ...
    <section class="q-mt-sm ">
      ...
      <q-tab-panels v-model="tab" animated>
          <q-tab-panel name="movement">
            <q-banner rounded class="bg-grey-4 q-mb-sm">
              <div class="row q-gutter-x-sm">
                <q-input label="Pesquise" outlined v-model="filterMovement" dense style="width:200px" class="bg-white rounded-borders">
                  <template v-slot:prepend>
                    <q-icon name="search" size="20px" color="black"/>
                  </template>
                </q-input>
                <q-select outlined v-model="selectedDate" dense :options="['02/2025','03/2025']"  style="width:200px" class="bg-white rounded-borders">
                  <template v-slot:prepend>
                    <q-icon 
                      name="calendar_month" 
                      size="20px" 
            ...
            >
              ...
              <template v-slot:body="props">
                <q-tr :props="props" class="cursor-pointer"  :class="props.row.type === 'entrada' ? 'text-green' : 'text-red'">
                  ...
                  <q-td key="category" :props="props" class="text-left" @click="setShowInformationMovement(props.rowIndex)">
                    {{ props.row.category }}
                  </q-td>
                  <q-td key="account" :props="props" class="text-left" @click="setShowInformationMovement(props.rowIndex)">
                    {{ props.row.account }}
                  </q-td>
          ...
          <q-tab-panel name="schedule">
            <q-banner rounded class="bg-grey-4 q-mb-sm">
              <div class="row q-gutter-x-sm">
                <q-input label="Pesquise" outlined v-model="filterSchedule" dense style="width:200px" class="bg-white rounded-borders">
                  <template v-slot:prepend>
                    <q-icon name="search" size="20px" color="black"/>
                  </template>
                </q-input>
            ...
            >
              ...
              <template v-slot:body="props">
                <q-tr :props="props" class="cursor-pointer" :class="props.row.type === 'entrada' ? 'text-green' : 'text-red'">
                  <q-td key="date_movement" :props="props" class="text-left" @click="setShowInformationSchedule(props.rowIndex)">
                    {{ props.row.date_movement }}
                  </q-td>
                  <q-td key="value" :props="props" class="text-left" @click="setShowInformationSchedule(props.rowIndex)">
                    {{ props.row.value }}
                  </q-td>
                  <q-td key="category" :props="props" class="text-left" @click="setShowInformationSchedule(props.rowIndex)">
                    {{ props.row.category }}
                  </q-td>
                  <q-td key="account" :props="props" class="text-left" @click="setShowInformationSchedule(props.rowIndex)">
                    {{ props.row.account }}
                  </q-td>
                  <q-td key="action" :props="props">
                    <q-btn
