    ...
    <section class="q-mt-sm">
      <q-banner rounded class="bg-grey-4 q-mb-sm">
        <div class="row q-gutter-x-sm">
          <q-input label="Pesquise" outlined v-model="filterStock" dense style="width:200px" class="bg-white rounded-borders">
        ...
        <template v-slot:body="props">
          ...
          <q-tr :props="props" :class="props.row.code == 100 ? 'text-red' : ''">
            ...
            <q-td key="quantity" :props="props" class="text-left" >
              {{ props.row.quantity }}
              <q-btn outline flat round color="primary" icon="search" dense size="sm" class="q-ml-sm"/>
            </q-td>
