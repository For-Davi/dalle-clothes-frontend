    ...
    <section class="q-mt-sm">
      <q-banner rounded class="bg-grey-4 q-mb-sm">
        <div class="row q-gutter-x-sm">
          <q-input label="Pesquise" outlined v-model="filterMotocyclist" dense style="width:200px" class="bg-white rounded-borders">
      ...
      >
        ...
        <template v-slot:body="props">
          <q-tr :props="props"   class="cursor-pointer">
            ...
            <q-td key="delivery" :props="props" class="text-left" @click="setShowInformation(props.rowIndex)">
              {{ props.row.delivery }}
            </q-td>
